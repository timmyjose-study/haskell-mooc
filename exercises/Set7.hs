...
passwordAllowed password (ContainsSome s) = any (\c -> elem c s) password
passwordAllowed password (DoesNotContain s) = not $ any (\c -> elem c s) password
...
operation "+" a1 a2 = Add a1 a2
operation "*" a1 a2 = Mul a1 a2
